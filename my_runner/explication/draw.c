...
{//mise en place de tous les dessins en mode jeu courant
	sfRenderWindow_drawSprite(win->window, plx->moon->spr, NULL);
	sfRenderWindow_drawSprite(win->window, plx->sky->spr, NULL);
	sfRenderWindow_drawSprite(win->window, plx->one->spr, NULL);
	sfRenderWindow_drawSprite(win->window, plx->two->spr, NULL);
	sfRenderWindow_drawSprite(win->window, plx->three->spr, NULL);
...
{//mise en place de tout les dessins en mode menu
	sfRenderWindow_drawSprite(win->window, plx->moon->spr, NULL);
	sfRenderWindow_drawSprite(win->window, plx->sky->spr, NULL);
	sfRenderWindow_drawSprite(win->window, plx->one->spr, NULL);
	sfRenderWindow_drawSprite(win->window, plx->two->spr, NULL);
